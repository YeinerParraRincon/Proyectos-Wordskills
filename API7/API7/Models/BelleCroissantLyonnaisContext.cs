...
public partial class BelleCroissantLyonnaisContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__LoyaltyP__A4AE64D8BCE9A199");
        ...
        {
            entity.HasKey(e => e.PromotionId).HasName("PK__Promotio__52C42FCF840F2E77");
        ...
        {
            entity.HasKey(e => e.RuleId).HasName("PK__Quantity__110458E26F57A068");

            entity.Property(e => e.DiscountValue).HasColumnType("decimal(10, 2)");

            entity.HasOne(d => d.Promotion).WithMany(p => p.QuantityBasedRuleDetails)
                .HasForeignKey(d => d.PromotionId)
                .HasConstraintName("FK__QuantityB__Promo__0A9D95DB");
        });
